...
if ( ! function_exists( 'portfolio_setup' ) ) :
	...
	function portfolio_setup() {
		...
		register_nav_menus(
			array(
				'menu-header' => esc_html__( 'Primary', 'portfolio' ),
				'menu-footer' => esc_html__( 'Footer', 'portfolio' ),
...
function portfolio_scripts() {
	...
	wp_enqueue_script( 'bundle', get_template_directory_uri() . './build/bundle.js', array(),"1.0", true );

	wp_enqueue_script( 'portfolio-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true );
